...
<div id="signatureparent">
    ...
    <button type="button" id="btnClear">Borrar</button>
...
<!--For testing only-->
<textarea style="display:none;" rows="2" cols="150" id="textSigData" name="textSigData"></textarea>
<!--The image display-->
<img style= "display: block; margin-left: auto; margin-right: auto; width: 50%;" id="imgSigData" name="imgSigData"  src="" />
